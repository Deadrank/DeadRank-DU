...
function radarWidget()
    ...
    if radarOverload then 
        rw = rw .. [[ 
            <svg width="100%" height="100%" style="position: absolute;left:0%;top:0%;font-family: Calibri;">
            <rect x="]].. tostring(.45 * screenWidth) ..[[" y="]].. tostring(.15 * screenHeight) ..[[" rx="15" ry="15" width="9vw" height="4vh" style="fill:rgba(50, 50, 50, 0.9);stroke:red;stroke-width:5;opacity:0.9;" />
            <text x="]].. tostring(.46 * screenWidth) ..[[" y="]].. tostring(.175 * screenHeight) ..[[" style="fill: ]]..'red'..[[" font-size=".8vw" font-weight="bold">
